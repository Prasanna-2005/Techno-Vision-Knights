...
class Home extends Component {
    ...
    checkLoginStatus = async () => {
        try {
            const response = await fetch('https://appsail-50025756479.development.catalystappsail.in/check-auth', { credentials: 'include' });
    ...
    getMovies = async () => {
        ...
        let url = 'https://appsail-50025756479.development.catalystappsail.in/movie_grid_layout';

        if (filter === 'top-rated') url = 'https://appsail-50025756479.development.catalystappsail.in/movies/top-rated';
        else if (filter === 'language') url = `https://appsail-50025756479.development.catalystappsail.in/movies/lang?language=${selectedLanguage}`;
        else if (filter === 'genre') url = `https://appsail-50025756479.development.catalystappsail.in/movies/genre?genre=${selectedGenre}`;
        else if (filter === 'liked' || filter === 'watchlisted') {
            if (!isLoggedIn) {
                this.setState({ redirectToLogin: true });
                return;
            }
            url = filter === 'liked' ? 'https://appsail-50025756479.development.catalystappsail.in/movies/liked' : 'https://appsail-50025756479.development.catalystappsail.in/movies/watchlists';
        }
