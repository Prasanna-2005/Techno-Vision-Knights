...
const Profile = () => {
    ...
    useEffect(() => {
        // Fetch profile data
        fetch('https://appsail-50025756479.development.catalystappsail.in/profile', { credentials: 'include' })
            .then(res => res.json())
            .then(data => {
                setProfile(data);
        ...
        fetch('https://appsail-50025756479.development.catalystappsail.in/movies/liked', { credentials: 'include' })
            .then(res => res.json())
            .then(data => {
        ...
        fetch('https://appsail-50025756479.development.catalystappsail.in/movies/watchlists', { credentials: 'include' })
            .then(res => res.json())
            .then(data => {
