...
const Eachmoviedetails = () => {
    ...
    useEffect(() => {
        const getMovieDetails = async () => {
            try {
                const response = await fetch(`https://appsail-50025756479.development.catalystappsail.in/movie/${id}`, {
                    method: 'GET',
                    credentials: 'include'
                });
    ...
    const fetchReviews = async () => {
        setIsLoading(true);
        try {
            const response = await fetch(`https://appsail-50025756479.development.catalystappsail.in/review/${id}`, { credentials: 'include' });
    ...
    const submitReview = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`https://appsail-50025756479.development.catalystappsail.in/review/${id}?rating=${reviewRating}`, {
                method: 'POST',
                headers: { 
    ...
    const toggleLike = async () => {
        ...
        try {
            const response = await fetch(`https://appsail-50025756479.development.catalystappsail.in/movie/toggle-like/${id}`, {
                method: 'GET',
                credentials: 'include'
            });
    ...
    const toggleWatchlist = async () => {
        ...
        try {
            const response = await fetch(`https://appsail-50025756479.development.catalystappsail.in/movie/toggle-watchlist/${id}`, {
                method: 'GET',
                credentials: 'include'
            });
